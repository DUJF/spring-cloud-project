...
### 1. 服务注册中心 [服务注册中心](https://github.com/DUJF/angle-cloud-project/tree/master/angle-eureka)
### 2. 创建多个服务提供者（本实例中的client，client2)
服务资源微服务[clinet](https://github.com/DUJF/angle-cloud-project/tree/master/angle-config-client)
认证微服务[client2](https://github.com/DUJF/angle-cloud-project/tree/master/angle-config-client2)
### 3. 创建zuul网关[网关源码](https://github.com/DUJF/angle-cloud-project/tree/master/angle-zuul)
访问权限认证中心[client2](https://github.com/DUJF/angle-cloud-project/tree/master/angle-eureka-client2)
...
### 4. 服务配置中心
. [配置服务端](https://github.com/DUJF/angle-cloud-project/tree/master/angle-config)
服务端搭建好后可以访问http://localhost:8014/config/client 获取到config-client.properties中的信息
**{"name":"config","profiles":["client"],"label":null,"version":null,"state":null,"propertySources":[{"name":"https://github.com/DUJF/angle-config.git/config-client.properties","source":{"name":"zhangsan","password":"123456"}}]}**

. 配置客户端[2](https://github.com/DUJF/angle-cloud-project/tree/master/angle-config-client)
...
```` 
. 配置文件放在git仓库里[配置文件](https://github.com/DUJF/angle-config)
----
